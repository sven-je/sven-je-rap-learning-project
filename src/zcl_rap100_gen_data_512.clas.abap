CLASS zcl_rap100_gen_data_512 DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_512 IMPLEMENTATION.
...
*   clear data
    DELETE FROM zrap100_atrav512.
    DELETE FROM zrp100_atrv512_d.

    "insert travel demo data
    INSERT zrap100_atrav512  FROM (
        SELECT
